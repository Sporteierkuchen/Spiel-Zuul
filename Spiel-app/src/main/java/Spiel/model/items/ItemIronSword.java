...
public class ItemIronSword extends Kampf_Item {
    ...
    public ItemIronSword(Integer anzahl) {
    	
		super("Eisenschwert", "Dieses Schwert hat eine ziemlich scharfe Klinge...", anzahl);
    }
    ...
    public int calculateDamage(){
		...
		System.out.println("--------------------------------------------------------------------------");
		System.out.println("Eisenschwert: " + damage + " Schaden");
		System.out.println("--------------------------------------------------------------------------");
        return damage;
    }
