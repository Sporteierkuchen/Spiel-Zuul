...
public class ItemHolzschwert extends Kampf_Item {
    ...
    public ItemHolzschwert(Integer anzahl) {
    	
		super("Holzschwert", "Dieses Schwert kann im Kampf helfen...", anzahl);
    }
    ...
    public int calculateDamage(){
		...
		System.out.println("--------------------------------------------------------------------------");
		System.out.println("Holzschwert: " + damage + " Schaden");
		System.out.println("--------------------------------------------------------------------------");
        return damage;
    }
